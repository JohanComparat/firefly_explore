...
x_M13, y_M13 = n.loadtxt( os.path.join(os.environ['HOME'],'software/linux/firefly_explore/data/literature/Maraston_13_05_06.txt' ), unpack=True) 
...
p.plot(x_M13, y_M13*0.7**3., label='Ma 13, 0.5<z<0.6', ls='dashed', lw=3)
