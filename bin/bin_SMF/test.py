...
p.fill_between(xs[0], y1=n.min(y_low, axis=0), y2=n.max(y_up, axis=0), color='r', alpha=0.1, label='DEEP2')
...
p.fill_between(xs[0], y1=n.min(y_low, axis=0), y2=n.max(y_up, axis=0), color='r', alpha=0.1, label='eBOSS')
...
p.fill_between(xs[0], y1=n.min(y_low, axis=0), y2=n.max(y_up, axis=0), color='b', alpha=0.1, label='SDSS')
