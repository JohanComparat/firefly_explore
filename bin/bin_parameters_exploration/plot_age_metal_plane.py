...
def plot_az_sdss(imf_ref):
	...
	p.colorbar(shrink=0.7, label=r'$\log_{10}(N)$')
	#p.legend(loc=0, frameon = False)
	p.text(-2.1, 75.,'SDSS '+imf_ref.split('_')[0] +' '+imf_ref.split('_')[1] .split('_')[0] +' '+imf_ref.split('_')[1] )
	p.grid()
	p.tight_layout()
...
def plot_az_deep2(imf_ref):
	...
	p.colorbar(shrink=0.7, label=r'$\log_{10}(N)$')
	p.legend(loc=0, frameon = False)
	p.text(-2.1, 75.,'DEEP2 '+imf_ref.split('_')[0] +' '+imf_ref.split('_')[1] .split('_')[0] +' '+imf_ref.split('_')[1] )
	p.grid()
	p.tight_layout()
