...
def plot_az_boss(imf_ref):
	...
	p.grid()
	p.text(-2.1, 7.5,'eBOSS '+imf_ref.split('_')[0] +' '+imf_ref.split('_')[1] )
	p.tight_layout()
	...
	p.legend(loc=0, frameon = False)
	p.grid()
	p.text(-2.1, 7.5,'eBOSS '+imf_ref.split('_')[0] +' '+imf_ref.split('_')[1] .split('_')[0] +' '+imf_ref.split('_')[1] )
	p.tight_layout()
...
def plot_az_sdss(imf_ref):
	...
	p.colorbar(shrink=0.7, label=r'$\log_{10}(N)$')
	#p.legend(loc=0, frameon = False)
	p.text(-2.1, 7.5,'SDSS '+imf_ref.split('_')[0] +' '+imf_ref.split('_')[1] .split('_')[0] +' '+imf_ref.split('_')[1] )
	p.grid()
	p.tight_layout()
	...
	p.grid()
	p.tight_layout()
	p.savefig(os.path.join(out_dir, "no_X_age_metallicity_"+imf_ref+"sdss_04.png" ))
	p.clf()
	p.figure(0, (5.5, 4.5))
	p.axes([0.2,0.2,0.7,0.7])
	HH = n.histogram2d(Z_04_ref, A_04_ref, bins=[z_bins, a_bins])[0].T
	...
	p.grid()
	p.tight_layout()
	p.savefig(os.path.join(out_dir, "no_Y_age_metallicity_"+imf_ref+"sdss_04.png" ))
	p.clf()
	p.figure(0, (5.5, 4.5))
	p.axes([0.2,0.2,0.7,0.7])
	HH = n.histogram2d(Z_04_ref, A_04_ref, bins=[z_bins, a_bins])[0].T
	...
	p.grid()
	p.tight_layout()
	p.savefig(os.path.join(out_dir, "no_XY_age_metallicity_"+imf_ref+"sdss_04.png" ))
	p.clf()
...
def plot_az_deep2(imf_ref):
	...
	p.colorbar(shrink=0.7, label=r'$\log_{10}(N)$')
	p.legend(loc=0, frameon = False)
	p.text(-2.1, 7.5,'DEEP2 '+imf_ref.split('_')[0] +' '+imf_ref.split('_')[1] .split('_')[0] +' '+imf_ref.split('_')[1] )
	p.grid()
	p.tight_layout()
	...
	p.grid()
	p.tight_layout()
	p.savefig(os.path.join(out_dir, "no_X_age_metallicity_"+imf_ref+"deep2_04.png" ))
	p.clf()
	p.figure(0, (5.5, 4.5))
	p.axes([0.2,0.2,0.7,0.7])
	HH = n.histogram2d(Z_04_ref, A_04_ref, bins=[z_bins, a_bins])[0].T
	...
	p.grid()
	p.tight_layout()
	p.savefig(os.path.join(out_dir, "no_Y_age_metallicity_"+imf_ref+"deep2_04.png" ))
	p.clf()
	p.figure(0, (5.5, 4.5))
	p.axes([0.2,0.2,0.7,0.7])
	HH = n.histogram2d(Z_04_ref, A_04_ref, bins=[z_bins, a_bins])[0].T
	...
	p.grid()
	p.tight_layout()
	p.savefig(os.path.join(out_dir, "no_XY_age_metallicity_"+imf_ref+"deep2_04.png" ))
	p.clf()
