...
\subsubsection{Theoretical performances from \citet{firefly2017MNRAS}}
...
Each model is characterized by a number of SSPs given in the caption. Gaps in the spectrum correspond to regions masked due to the presence of emission lines. 
%
The {\bf second panel} shows the ratio of the data divided by the model as a function of wavelength colored. The black lines correspond to the 1$\sigma$ uncertainties. %\textcolor{red}{replace by residuals, not very useful ... move title up}
...
The results point overall towards a metallicity value of 10$^{0.2}Z_\odot$, an age of 10$^{10}$yr, E(B-V) between 0.15 and 0.2. and a mass between 10$^{10.8}$ and 10$^{11}M_\odot$. 
The STELIB library points toward the more massive and older stellar populations than MILES and ELODIE.
On the {\bf third row}: age - metallicity, age - stellar mass, mass weight - age of individual SSPs. 
On the {\bf fourth row}:  mass - metallicity, mass - reddenning, mass weight - metalliticy of individual SSPs. 
...
Example of a fit taken from the first plate of BOSS. The spectrum considered in this Figure is plate=3586, mjd=55181, fiberid=3. 
The {\bf top panel} shows the observed spectrum (grey line) and its models (colored lines). 
Each model is characterized by a number of SSPs given in the caption. Gaps in the spectrum correspond to regions masked due to the presence of emission lines. 
%
The {\bf second panel} shows the ratio of the data divided by the model as a function of wavelength colored. The black lines correspond to the 1$\sigma$ uncertainties. 
% The middle panel shows the $\chi^2$ distribution per pixel for each fit compared to a normal distribution (labeled N(0,1), dashed line). 
%
The {\bf third and fourth rows} of panels show the values of the parameters fitted and their $1\sigma$ uncertainties. 
The results point overall towards two possible combinations of age, metallicity 
(10$^{-2}Z_\odot$, 10$^{9.75}$yr) or and 
(10$^{0}Z_\odot$, 10$^{9}$yr). 
The second solution is constrained by the small coverage in age-metallicity of the STELIB library. 
Both combinations indicate a stellar mass between 10$^{10}$ and 10$^{11}M_\odot$. 
The STELIB library points toward the more massive and older stellar populations than MILES and ELODIE.
On the {\bf third row}: age - metallicity, age - stellar mass, mass weight - age of individual SSPs. 
On the {\bf fourth row}:  mass - metallicity, mass - reddenning, mass weight - metalliticy of individual SSPs. 
% The bottom panel shows the output parameters stellar mass (y-axis) vs stellar age (x-axis), which nicely agree. Each blue point refers to one of the nine models. The blue points are related to their respective caption by black arrows. 
...
\includegraphics[width=14cm]{plots/spFly-3586-55181-0003.png}
\end{center}
\end{figure*}
...
Example of a fit taken from the first plate of an DEEP2 spectrum considered in this analysis: mask=1103, objno=11013914. 
The {\bf top panel} shows the observed spectrum (grey line) and its models (colored lines). 
Each model is characterized by a number of SSPs given in the caption. Gaps in the spectrum correspond to regions masked due to the presence of emission lines. 
%
The {\bf second panel} shows the ratio of the data divided by the model as a function of wavelength colored. The black lines correspond to the 1$\sigma$ uncertainties. %\textcolor{red}{replace by residuals, not very useful ... move title up}
...
\includegraphics[width=14cm]{plots/spFly-deep2-1103-11013914.png}
\end{center}
\end{figure*}
