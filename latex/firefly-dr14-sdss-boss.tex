...
\and
Violeta Gonzalez-Perez\inst{2,} \inst{10}
\and
Jianhui Lian\inst{2}
\and
...
\and
Energy Lancaster, Lancaster University, Lancaster LA14YB, UK\\
}
...
We find the resulting stellar mass function based on SDSS or eBOSS in agreement with previous studies (e.g. Maraston et al. 2013) 
...
We retrieved about 2.7 million optical galaxy spectra; $948,259$ were observed with the SDSS spectrograph setup and with $1,759,362$ with the BOSS spectrograph setup.%, see Table \ref{table:single:spectra}. 
...
We show distributions and comparisons of the dust, stellar age, stellar metallicity and stellar mass obtained in Sec. \ref{sec:results:params}.
...
We rectify the continuum shape of both observations and models by multiplying them by a function, referred to as High-Pass Filter, (HPF). 
...
\subsubsection{Wavelength range and age estimation}
...
\citet{firefly2017MNRAS} compared (section 6.2, Figs. 24, 25) the \textsc{firefly}-SDSS measurements to the results from \citet{CidFernandes2005MNRAS358363C,Tojeiro2009ApJS1851T}.
% \textcolor{blue}{Cid-Fernandes et al. (2005) and from Tojeiro et al. (2009)}. 
In both cases, a good qualitative agreement was found.
...
\subsection{Input parameters used}
...
\begin{figure*}
\begin{center}
\caption{\label{fig:firefly:output:sdss}
Example of a fit taken from a plate of SDSS. 
The spectrum considered in this Figure is plate=0266, mjd=51602, fiberid=4 and features a galaxy at redshift 0.588.. 
The {\bf top panel} shows the observed spectrum (grey line) and its models (colored lines). 
Each model is characterized by the number of SSPs given in the caption. Gaps in the spectrum correspond to regions masked due to the presence of emission lines. 
The {\bf second panel} shows the $\chi^2$ distribution per pixel for each model compared to a normal distribution (labeled N(0,1), dashed line).
The {\bf third and fourth rows} of panels show the values of the parameters fitted and their $1\sigma$ uncertainties. 
On the {\bf third row} from left to right: panel 1 shows age vs. metallicity, panel 2 shows age vs. stellar mass and panel 3 shows mass weight vs. age of individual SSPs. 
On the {\bf fourth row} from left to right: panel 1 shows mass vs. metallicity, panel 2 shows mass vs. reddenning and panel 3 shows mass weight vs. metalliticy of individual SSPs. 
The results point overall towards a metallicity value of 10$^{0.2}Z_\odot$, an age of 10$^{10}$yr, E(B-V) between 0.15 and 0.2. and a mass between 10$^{10.75}$ and 10$^{11}M_\odot$. 
The STELIB library points toward the more massive and older stellar populations than MILES and ELODIE.
The decomposition in SSPs shows the solution is constituted of two old SSPs: one with solar metallicity and one with higher metallicity. 
}
\includegraphics[width=14cm]{/home/comparat/software/firefly_explore/data/spec_plot/spFly-0266-51602-0004.png}
\end{center}
\end{figure*}
...
\includegraphics[width=14cm]{/home/comparat/software/firefly_explore/data/spec_plot/spFly-3586-55181-0003.png}
\end{center}
\end{figure*}
...
\includegraphics[width=14cm]{/home/comparat/software/firefly_explore/data/spec_plot/spFly-deep2-1103-11013914.png}
\end{center}
\end{figure*}
...
In this section we describe the results of the fitting procedure. 
...
\subsection{Ages and metallicities}
...
SDSS occupies mostly the space of old and metal rich galaxies. 
eBOSS due to its higher mean redshift occupies slightly youger ages and slightly lower metallicities. 
DEEP2 occupies a complementary space: lower ages and metallicities. It seems that a certain number of fits are occupying the lowest metallicity region edge of the parameter space, meaning these values may be not very well constrained.
The distributions in this plane using the MILES and the ELODIE libraries are similar. 
The small coverage in metallicities of the STELIB library clearly stands out. 
A quantitative comparison between the obtained ages and  metallicities is shown on Fig. \ref{fig:distributions:MwA}, \ref{fig:distributions:MwZ}, described in the next paragraphs.
\textcolor{blue}{Add more comments and description}
...
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_X_age_metallicity_Chabrier_ELODIE_sdss_04.png}
\hspace*{-1.78cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_XY_age_metallicity_Chabrier_MILES_sdss_04.png}
\hspace*{-1.78cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_XY_age_metallicity_Chabrier_STELIB_sdss_04.png} \\
\vspace*{-1.1cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_X_age_metallicity_Chabrier_ELODIE_eboss_04.png}
\hspace*{-1.78cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_XY_age_metallicity_Chabrier_MILES_eboss_04.png}
\hspace*{-1.78cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_XY_age_metallicity_Chabrier_STELIB_eboss_04.png}\\
\vspace*{-1.1cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/age_metallicity_Chabrier_ELODIE_deep2_04.png}
\hspace*{-1.78cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_Y_age_metallicity_Chabrier_MILES_deep2_04.png}
\hspace*{-1.78cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/az/no_Y_age_metallicity_Chabrier_STELIB_deep2_04.png}
\end{center}
\end{figure}
...
We find that at fixed stellar libraries (varying only the IMF) ages are always consistent within $1\sigma$. 
Differently, when fixing the IMF and varying the library, we find differences. 
...
The ages obtained with STELIB are discrepant from the other two libraries due to the small coverage in metallicity of the library. 
Fig. \ref{fig:distributions:MwA} shows the distribution of the difference of age normed by the $1\sigma$ uncertainty on the parameter when varying the libraries: ELODIE, MILES, STELIB (fixed IMF: Chabrier). 
\textcolor{blue}{Add more comments and description}
...
Normed distribution (area is equal to 1) of the difference in age weighted by its $1\sigma$ uncertainty obtained when assuming different libraries and fixed IMF for the DEEP2 (left) and the SDSS (middle) and eBOSS (right) samples. 
This Figure quantifies the differences seen qualitatively between libraries in Fig. \ref{fig:distributions:AZ}. 
The Gaussian distribution (labeled N(0,1)) shows the width of the distribution expected if the ages derived agree within errors. 
MILES and ELODIE ages are in good agreement but STELIB and ELODIE ages disagree.}  
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_A_distribution_deep2Chabrier.png}
\hspace*{-0.5cm}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_A_distribution_sdssChabrier.png}
\hspace*{-0.5cm}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_A_distribution_ebossChabrier.png}
\end{center}
\end{figure}
...
We find that, at fixed IMF and varying the stellar libraries, metallicities are not always consistent. 
...
In the SDSS sample, is it close to being consistent: the distribution shows a small systematic shift, but the overall width is comparable to that of tha Gaussian. 
In the DEEP2 sample, errors are very large, so it seems consistent but the parameter is quite unconstrained.
In the eBOSS sample, there are systematic deviations when comparing either MILES and ELODIE or MILES and STELIB. The distribution is broader than the Gaussian meaning a disagreement between the parameter estimation. 
We thus warn the future user to be cautious when using the metallicity parameters fitted on the eBOSS data. 
\textcolor{blue}{Add more comments and description}

\begin{figure}
\begin{center}
\caption{\label{fig:distributions:MwZ} 
Same as Fig. \ref{fig:distributions:MwA} for the stellar metallicity.}  
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_Z_distribution_deep2Chabrier.png}
\hspace*{-0.5cm}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_Z_distribution_sdssChabrier.png}
\hspace*{-0.5cm}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_Z_distribution_ebossChabrier.png}
\end{center}
\end{figure}
\subsection{Dust and stellar masses}
\label{subsec:res:dust:mass}
Similarily to the age-metallicity degeneracy exist the dust-mass degeneracy. 
We show in Fig. \ref{fig:distributions:DM} how each dataset occupies the input parameter space of dust and stellar mass. 
The distributions obtained with ELODIE and MILES are similar. 
Fits done with the STELIB library favors lower dust attenuation due to its lesser low metallicity coverage. 
We directly compare the values obtained in Figs \ref{fig:distributions:EBV}, \ref{fig:comparison:imfs:MS}, \ref{fig:distributions:MwM}. 
DEEP2 galaxies seem to cluster on the low E(B-V) side, it may be due to the small wavelength coverage.
Note that due to a larger volume and a preselection to include only massive galaxies, eBOSS seems to contain more massive galaxies than SDSS although the mean redshift is greater. 
\textcolor{blue}{Add more comments and description}
...
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_X_dust_mass_Chabrier_ELODIE_sdss_04.png}
\hspace*{-1.7cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_XY_dust_mass_Chabrier_MILES_sdss_04.png}
\hspace*{-1.7cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_XY_dust_mass_Chabrier_STELIB_sdss_04.png} \\
\vspace*{-1.1cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_X_dust_mass_Chabrier_ELODIE_eboss_04.png}
\hspace*{-1.7cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_XY_dust_mass_Chabrier_MILES_eboss_04.png}
\hspace*{-1.7cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_XY_dust_mass_Chabrier_STELIB_eboss_04.png}\\
\vspace*{-1.1cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/dust_mass_Chabrier_ELODIE_deep2_04.png}
\hspace*{-1.7cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_Y_dust_mass_Chabrier_MILES_deep2_04.png}
\hspace*{-1.7cm}
\includegraphics[height=5.5cm]{/home/comparat/software/firefly_explore/data/images/dust-mass/no_Y_dust_mass_Chabrier_STELIB_deep2_04.png}
\end{center}
\end{figure}
...
DEEP2 has a limited wavelength coverage so this directly impacts the ability of the software to constrain E(B-V) and in most cases it is 0.
The IMF assumed does not change the E(B-V) value fitted, as expected.%, see Fig. \ref{fig:distributions:EBV2}. 
...
\includegraphics[width=6cm]{/home/comparat/software/firefly_explore/data/images/ebv/delta_EBV_distribution_sdssChabrier.png}
\hspace*{-0.6cm}
\includegraphics[width=6cm]{/home/comparat/software/firefly_explore/data/images/ebv/delta_EBV_distribution_ebossChabrier.png}
\hspace*{-0.6cm}
\includegraphics[width=6cm]{/home/comparat/software/firefly_explore/data/images/ebv/delta_EBV_distribution_deep2Chabrier.png}
\end{center}
\end{figure}

\subsubsection{Stellar mass}
\label{subsec:mass}
Stellar masses obtained with the Kroupa IMF are systematically larger than the ones with Chabrier and Salpeter. 
Fig. \ref{fig:comparison:imfs:MS} shows the difference in the stellar masses obtained when initial mass functions are varied, with the library fixed to MILES. It shows that the systematic difference in the masses inferred is larger than the statistical uncertainty on the stellar mass. 
...
Direct comparison of the stellar masses fitted for a fixed stellar library (MILES) varying the IMF. 
...
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_M_distribution_sdssMILES.png}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_M_distribution_ebossMILES.png}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_M_distribution_deep2MILES.png}
\end{center}
\end{figure}
...
Direct comparison of the stellar parameters fitted varying the library used (fixed IMF to Chabrier). 
If the obtained distribution is narrower than a normal distribution (depicted with the line 'N(0,1)') then measurements agree within errors. 
}  
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_M_distribution_deep2Chabrier.png}
\hspace*{-0.5cm}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_M_distribution_sdssChabrier.png}
\hspace*{-0.5cm}
\includegraphics[height=5.6cm]{/home/comparat/software/firefly_explore/data/images/delta_M_distribution_ebossChabrier.png}
\end{center}
\end{figure}
...
Then we discuss how the uncertainty of the fitted parameters is related to oservational parameters in Sec. \ref{subsec:about:convergence}. 

\subsection{General statements}
\label{subsec:overall:results}
The results span a large redshift and mass range. 
Fig. \ref{fig:nz} shows the redshift distribution of the galaxies with determined stellar properties.
Fig. \ref{fig:MZ} shows the distribution in the mass redshift plane. 
...
\includegraphics[width=16cm]{plots/redshift_distribution.png}
\end{center}
\end{figure*}
...
\includegraphics[height=7.5cm]{plots/mass_redshift_mass_Chabrier_ELODIE_sdss_boss_02.png}
\hspace*{-0.5cm}
\includegraphics[height=7.5cm]{plots/mass_redshift_mass_Chabrier_ELODIE_deep2_02.png} \\
\hspace*{-0.5cm}
\includegraphics[height=7.5cm]{plots/mass_redshift_mass_Chabrier_ELODIE_sdss_boss_04.png}
\hspace*{-0.5cm}
\includegraphics[height=7.5cm]{plots/mass_redshift_mass_Chabrier_ELODIE_deep2_04.png}
\end{center}
\end{figure*}


\subsubsection{SDSS and eBOSS}
...
\subsubsection{DEEP2}
The DEEP2 outputs contains $21,273$ galaxies in the redshift range $0.7<z<1.2$; see Table \ref{table:single:spectra:deep2}. The fitting routine converges for all. The fraction of spectra for which the parameters obtained are precise is small: less than 40\%.
The median signal to noise ratio in the DEEP2 spectrum is indeed quite low. 
Among the 22,873, 30\% have a SNR below 1 and only 10\% above 2. Only 200 have a SNR above 5. With this sample we will noto be able to explore detailed properties of the stellar population. 
This distribution explains why in the Table roughly 35\% (15\%) have a stellar mass constrained within 0.4 (0.2) dex. 
...
\begin{tabular}{ll rrr}
\hline \hline
\multicolumn{5}{c}{DEEP2 DR4: $21,273$ galaxies $0.7<z<1.2$} \\                
IMF &                                                                          
Library & 
$M>0$ & 
$\sigma_{\log_{10}M}<0.4$ dex & 
...
\subsubsection{Common objects between SDSS, eBOSS and DEEP2}
...
\subsubsection{Trends in SDSS data: source type, signal to noise ratio, redshift}
...
\$\{IMF\}\_\$\{LIBRARY\}\_remnant\_mass: stellar mass in remnants \newline 
