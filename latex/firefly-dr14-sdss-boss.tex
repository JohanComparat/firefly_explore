...
From a macroscopic or thermodynamical point of view, galaxies are typically described as systems composed of the tightly interacting sub-systems: the dark matter halo, the central black hole, the stars, the cold gas, the hot gas and the dust. 
...
These code and models are shown to be able to reconstruct accurately a galaxy star formation history from spectra with signal to noise ratios (SNR) of about 5 per pixel, as confirmed by extensive testing using mock galaxies, real galaxies and star clusters \citep[see, ][and Sec. \ref{subsec:firefly:performances}]{firefly2017MNRAS}. FF models were used in a variety of recent stellar population studies using SDSS-IV integral field spectroscopy data \citep{Wilkinson_2015,Goddard2017MNRAS.465..688G,Goddard2017MNRAS.466.4731G,2018MNRAS.474.1143L,2018MNRAS.476.3883L,2018MNRAS.477.3954P}.
...
We detail the results obtained for the four main parameters fitted: stellar masse, age, metallicity and reddenning. 
...
An example of SDSS (BOSS) spectrum and FF model is shown on Fig. \ref{fig:firefly:output:sdss} (\ref{fig:firefly:output:boss}).


\begin{figure*}
\begin{center}
\caption{\label{fig:firefly:output:sdss}
Example of a fit taken from the first plate of an SDSS spectrum considered in this analysis: plate=0266, mjd=51602, fiberid=0004. 
...
Example of a fit taken from the first plate of an BOSS spectrum considered in this analysis: plate=XXX, mjd=XXXXX, fiberid=XXXX. 
The {\bf top panel} shows the observed spectrum (grey line) and its models (colored lines). 
Each model is characterized by a number of SSPs given in the caption. Gaps in the spectrum correspond to regions masked due to the presence of emission lines. 
%
The {\bf second panel} shows the ratio of the data divided by the model as a function of wavelength colored. The black lines correspond to the 1$\sigma$ uncertainties. \textcolor{red}{replace by residuals, not very useful ... move title up}
...
\subsubsection{Trends with source types, signal to noise ratio, redshift}
...
Out of the $50,319$ entries in the DEEP2 DR4 catalog, $34,972$ are considered for a stellar population model fit and about $22,873$ unique objects within $0.7<z<1.2$, see Table \ref{table:single:spectra:deep2} for the detailed numbers. 
...
An example of DEEP2 spectrum and FF model is shown on Fig. \ref{fig:firefly:output:deep2}
...
Example of a fit taken from the first plate of an DEEP2 spectrum considered in this analysis: mask=XXX, mjd=XXXX, slit=xxxxx. 
The {\bf top panel} shows the observed spectrum (grey line) and its models (colored lines). 
Each model is characterized by a number of SSPs given in the caption. Gaps in the spectrum correspond to regions masked due to the presence of emission lines. 
%
The {\bf second panel} shows the ratio of the data divided by the model as a function of wavelength colored. The black lines correspond to the 1$\sigma$ uncertainties. \textcolor{red}{replace by residuals, not very useful ... move title up}
...
\subsection{Public data created}
...
Normed cumulative distribution of the E(B-V) fitted (top row). The IMF assumed does not make a difference. Due to different wavelength coverage the library assumed, the E(B-V) values measured differ by up to 0.2 dex. Direct comparison of the retrieved dust value for the Chabrier IMF varying libraries (bottom row). Main differences in the distributions are due to wavelength coverage.}  
...
\includegraphics[height=4.5cm]{/home/comparat/software/firefly_explore/data/images/az/age_metallicity_Chabrier_ELODIE_deep2_04.png}
 \includegraphics[height=4.5cm]{/home/comparat/software/firefly_explore/data/images/az/age_metallicity_Chabrier_MILES_deep2_04.png}
\includegraphics[height=4.5cm]{/home/comparat/software/firefly_explore/data/images/az/age_metallicity_Chabrier_STELIB_deep2_04.png}
\end{center}
\end{figure}
% 
% \begin{figure}
